...
const Home = () => {
  ...
  return (
    <div className="flex flex-col sm:flex-row w-screen h-screen sm:divide sm:divide-x divide-gray-300 divide-solid">
      <div className="flex-1 sm:flex-[2] grid place-items-center p-6 sm:p-8">
        <div className="flex flex-col space-y-4">
          ...
          <div className="sm:hidden pt-4">
            <Button startIcon={<Google />} onClick={initGoogleSignIn} size="large" variant="contained" fullWidth>
              Sign In with Google
            </Button>
          </div>
        </div>
